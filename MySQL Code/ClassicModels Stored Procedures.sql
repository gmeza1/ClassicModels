...
(Customer, balance, credit limit, available credit, contact first name, contact last name, customer phone #, sales rep first name, sales rep last name, extension, email) */
